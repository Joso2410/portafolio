...
<div class="home_general" id="Inicio_Destino">
    ...
    <div style="display: flex;flex-direction: row;align-items: center;color: #ff8bfa;font-weight: 600;font-size: 25px;"><div class="linea_horizontal"></div>Hola<div class="linea_horizontal"></div></div>
    <h2 style="font-size: 52px;"> Soy <strong style="color: #ff8bfa;">José</strong></h2>
